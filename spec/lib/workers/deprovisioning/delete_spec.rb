...
describe Workers::Deprovisioning::Delete, type: :unit do
  describe '#perform' do
    ...
    context 'when deprovision schedule canceled' do
      let!(:schedule) { email.deprovision_schedules.create action: :delete, scheduled_for: 1.minute.ago, canceled: true }
    ...
    context 'when deprovision schedule not canceled' do
      let!(:schedule) { email.deprovision_schedules.create action: :delete, scheduled_for: 1.minute.ago }
